...
export default function InterviewCoachPage() {
  ...
  return (
    <div className={`min-h-screen bg-slate-50/50 flex flex-col font-sans relative overflow-hidden ${isAr ? "rtl" : "ltr"}`}>
      ...
      {/* Hero Header Area */}
      <main className="flex-1 max-w-5xl mx-auto w-full px-6 sm:px-8 py-24 mt-10 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16 select-none">
          ...
          <p className="text-slate-500 text-xs sm:text-[13px] font-semibold leading-relaxed mt-4 max-w-lg mx-auto">
            {isAr
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-3xl mx-auto mb-10 select-none text-start">
          <div className="bg-white border border-slate-150 rounded-2xl p-4 flex items-center gap-3.5 shadow-3xs transition hover:-translate-y-0.5 duration-200">
            ...
            <div>
              ...
              <span className="font-black text-slate-800 text-xs sm:text-[13px]">
          ...
          <div className="bg-white border border-slate-150 rounded-2xl p-4 flex items-center gap-3.5 shadow-3xs transition hover:-translate-y-0.5 duration-200">
            <div className="w-10 h-10 rounded-xl bg-[#FF4D2D]/5 text-[#FF4D2D] flex items-center justify-center shrink-0">
              <Trophy size={18} />
            </div>
            <div>
        ...
        <div className="max-w-3xl mx-auto bg-sky-50/40 border border-sky-100 rounded-2xl p-5 flex gap-4 text-start select-none">
          <AlertCircle size={18} className="text-sky-600 mt-0.5 shrink-0" />
          <div className="text-xs text-sky-950 font-medium space-y-1.5 leading-relaxed">
            <h5 className="font-black text-sky-850 flex items-center gap-1.5 text-sm">
