...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans selection:bg-green-200 selection:text-green-900">
      ...
      <div className="bg-green-600 text-white text-sm py-2 px-4 flex items-center justify-center gap-2 font-medium">
        <MessageCircle size={16} />
        <span>Need help? Chat with us on WhatsApp</span>
        <a href="#" className="underline hover:text-green-100 ml-2">Contact Support</a>
      </div>
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex justify-between items-center">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold tracking-tight text-slate-900">Hash Resume</span>
        </div>
        <div className="flex items-center gap-6">
          ...
          <Link to="/editor" className="bg-slate-900 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-slate-800 transition-colors">
            Go to Editor
          </Link>
        </div>
      </nav>
      ...
      <section className="relative pt-20 pb-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-100 text-green-800 text-sm font-medium mb-8"
          >
            <ShieldCheck size={16} />
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-500 to-emerald-600">Simplified.</span>
          </motion.h1>
          ...
          >
            <Link to="/editor" className="w-full sm:w-auto bg-green-500 text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-green-600 transition-all shadow-lg shadow-green-500/30 flex items-center justify-center gap-2 group">
              Build My Resume
              <ArrowRight size={20} className="group-hover:translate-x-1 transition-transform" />
            </Link>
            <p className="text-sm text-slate-500 font-medium">
              <span className="text-slate-900 font-bold">1k+</span> Resumes Exported
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="border-y border-slate-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-slate-100">
            <div>
              <p className="text-3xl font-bold text-slate-900 mb-1">2.5k+</p>
              <p className="text-sm text-slate-500 font-medium uppercase tracking-wider">Resumes This Month</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-slate-900 mb-1">&lt; 5m</p>
              <p className="text-sm text-slate-500 font-medium uppercase tracking-wider">Avg. Build Time</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-slate-900 mb-1">95%</p>
              <p className="text-sm text-slate-500 font-medium uppercase tracking-wider">ATS Pass Rate</p>
            </div>
            <div>
              <p className="text-3xl font-bold text-slate-900 mb-1">3x</p>
              <p className="text-sm text-slate-500 font-medium uppercase tracking-wider">Interview Success</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="py-24 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Everything you need to land the job</h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 relative">
            ...
            {[
              ...
              <div key={i} className="text-center relative">
                <div className="w-24 h-24 mx-auto bg-white border-4 border-slate-50 rounded-full flex items-center justify-center text-3xl font-black text-slate-200 mb-6 shadow-sm">
                  {item.step}
                </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-2 mb-6">
                <Logo className="w-8 h-8 text-green-500" />
                <span className="text-xl font-bold text-white">Hash Resume</span>
              </div>
