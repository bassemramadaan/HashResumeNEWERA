export const translations = {
  en: {
    landing: {
      ...
      feature5Title: "Free AI Content Generation",
      feature5Desc: "Overcome writer's block with our free AI assistant that generates professional summaries and bullet points tailored to your industry.",
      feature6Title: "Multiple Premium Templates",
      feature6Desc: "Choose from a variety of professionally designed templates that stand out while remaining ATS-compliant and easy to read.",
      ...
      faq2A: "Yes, Hash Resume is 100% free. You can create, preview, and download your professional resume and cover letter without any cost or subscription. Our AI features are also completely free to use.",
      ...
      faq5Q: "What export formats are supported?",
      faq5A: "You can export your resume to high-quality PDF for job applications, or to Microsoft Word (.docx) if you need to make manual adjustments later.",
      ...
      pricingSubtitle: "Build and download your professional resume without spending a penny. No hidden fees, no credit card required.",
  ...
  ar: {
    landing: {
      ...
      feature5Title: "توليد المحتوى بالذكاء الاصطناعي مجاناً",
      feature5Desc: "تغلب على قفلة الكاتب مع مساعدنا الذكي المجاني الذي يولد ملخصات احترافية ونقاط قوة مخصصة لمجالك.",
      feature6Title: "قوالب مميزة متعددة",
      feature6Desc: "اختر من بين مجموعة متنوعة من القوالب المصممة باحترافية والتي تبرز مع بقائها متوافقة مع أنظمة ATS وسهلة القراءة.",
      ...
      faq2Q: "هل هو مجاني حقاً؟",
      faq2A: "نعم، Hash Resume مجاني 100%. يمكنك إنشاء ومعاينة وتحميل سيرتك الذاتية الاحترافية وخطاب التقديم دون أي تكلفة أو اشتراك. ميزات الذكاء الاصطناعي لدينا مجانية تماماً للاستخدام.",
      ...
      faq5Q: "ما هي صيغ التصدير المدعومة؟",
      faq5A: "يمكنك تصدير سيرتك الذاتية بصيغة PDF عالية الجودة للتقديم على الوظائف، أو بصيغة Microsoft Word (.docx) إذا كنت بحاجة لإجراء تعديلات يدوية لاحقاً.",
      ...
      feedback: "رأيك يهمنا",
      pricingTitle: "مجاني 100% للأبد",
      pricingSubtitle: "أنشئ وحمل سيرتك الذاتية الاحترافية دون دفع مليم واحد. لا توجد رسوم خفية، ولا يلزم وجود بطاقة ائتمان.",
  ...
  fr: {
    landing: {
      ...
      feature5Title: "Génération de contenu par IA gratuite",
      feature5Desc: "Surmontez le syndrome de la page blanche avec notre assistant IA gratuit qui génère des résumés professionnels et des points clés adaptés à votre secteur.",
      feature6Title: "Plusieurs modèles premium",
      feature6Desc: "Choisissez parmi une variété de modèles conçus par des professionnels qui se démarquent tout en restant conformes aux ATS.",
      ...
      faq2Q: "Est-ce vraiment gratuit ?",
      faq2A: "Oui, Hash Resume est 100% gratuit. Vous pouvez créer, prévisualiser et télécharger votre CV professionnel et votre lettre de motivation sans aucun coût ni abonnement. Nos fonctionnalités d'IA sont également totalement gratuites.",
      ...
      pricingSubtitle: "Créez et téléchargez votre CV professionnel sans dépenser un centime. Pas de frais cachés, aucune carte de crédit requise.",
