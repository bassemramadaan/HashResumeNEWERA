export const translations = {
  en: {
    landing: {
      ...
      statsText: "50,000+ resumes created this month with 94% acceptance rate",
      ...
      faq2A: "You can build and preview your resume for free. We charge a small one-time fee (currently 25 EGP) only when you are ready to download your professional PDF or Word document. No subscriptions, no hidden fees.",
  ...
  ar: {
    landing: {
      ...
      statsText: "أكثر من 50,000 سيرة ذاتية تم إنشاؤها هذا الشهر بمعدل قبول 94%",
      ...
      faq2A: "يمكنك إنشاء ومعاينة سيرتك الذاتية مجانًا. نحن نفرض رسومًا رمزية تدفع لمرة واحدة فقط (حالياً 25 جنيه مصري) عندما تكون جاهزًا لتحميل ملف PDF أو Word الاحترافي. لا توجد اشتراكات شهرية أو رسوم خفية.",
  ...
  fr: {
    landing: {
      ...
      statsText: "Plus de 50 000 CV créés ce mois-ci avec un taux d'acceptation de 94%",
      ...
      faq2A: "Vous pouvez créer et prévisualiser votre CV gratuitement. Nous facturons des frais uniques minimes (actuellement 25 EGP) uniquement lorsque vous êtes prêt à télécharger votre PDF ou document Word professionnel.",
