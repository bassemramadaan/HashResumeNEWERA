export const translations = {
  en: {
    landing: {
      ...
      oneClickApplyStats: "One-click application to Hash Hunt",
  ...
  ar: {
    landing: {
      ...
      oneClickApplyStats: "تقديم بضغطة زر واحدة على Hash Hunt",
  ...
  fr: {
    landing: {
      ...
      oneClickApplyStats: "Candidature en un clic sur Hash Hunt",
