export const translations = {
  en: {
    landing: {
      ...
      faq2A: "You can build and preview your resume for free. We charge a one-time fee of 25 EGP (approx. 1.88 SAR, 1.83 AED, 0.48 €, 0.50 $) for a single professional PDF download. No subscriptions, no hidden fees.",
  ...
  ar: {
    landing: {
      ...
      faq2A: "يمكنك إنشاء ومعاينة سيرتك الذاتية مجانًا. نحن نفرض رسومًا لمرة واحدة قدرها 25 جنيه مصري (حوالي 1.88 ريال سعودي، 1.83 درهم إماراتي، 0.48 يورو، 0.50 دولار) لتحميل ملف PDF احترافي واحد. لا توجد اشتراكات أو رسوم خفية.",
  ...
  fr: {
    landing: {
      ...
      faq2A: "Vous pouvez créer et prévisualiser votre CV gratuitement. Nous facturons des frais uniques de 25 EGP (env. 1.88 SAR, 1.83 AED, 0.48 €, 0.50 $) pour un seul téléchargement PDF professionnel. Pas d'abonnements, pas de frais cachés.",
