export const translations = {
  en: {
    landing: {
      ...
      feature5Title: "AI Content Generation",
      feature5Desc: "Overcome writer's block with our AI assistant that generates professional summaries and bullet points tailored to your industry.",
  ...
  ar: {
    landing: {
      ...
      feature5Title: "توليد المحتوى بالذكاء الاصطناعي",
      feature5Desc: "تغلب على قفلة الكاتب مع مساعدنا الذكي الذي يولد ملخصات احترافية ونقاط قوة مخصصة لمجالك.",
  ...
  fr: {
    landing: {
      ...
      feature5Title: "Génération de contenu par IA",
      feature5Desc: "Surmontez le syndrome de la page blanche avec notre assistant IA qui génère des résumés professionnels et des points clés adaptés à votre secteur.",
