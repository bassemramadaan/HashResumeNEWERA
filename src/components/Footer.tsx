            ...
            <div className="col-span-2 lg:col-span-4">
              <div className="flex flex-col items-start mb-4">
                <Link to="/" className="inline-block transform origin-left rtl:origin-right hover:scale-105 transition-transform mb-2">
                  <img src="/logo-with-tag-light.png" alt="Hash Resume" className="h-10 md:h-12 w-auto max-w-full object-contain pointer-events-none" loading="lazy" decoding="async" />
                </Link>
              </div>
