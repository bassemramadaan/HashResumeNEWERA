          ...
          <div className="p-8 text-center">
            ...
            <div className="bg-indigo-50 border border-indigo-100 rounded-2xl p-6 mb-8 text-left">
              ...
              <a 
                ...
                onClick={onClose}
                className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 rounded-xl font-medium transition-colors flex items-center justify-center gap-2 shadow-lg shadow-indigo-600/20"
              >
