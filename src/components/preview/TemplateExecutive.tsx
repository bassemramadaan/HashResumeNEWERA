...
const TemplateExecutive: React.FC<{ data: ResumeData; isMini?: boolean }> = ({ data, isMini }) => {
  ...
  return (
    <div className={`w-[794px] mx-auto bg-white font-sans text-[#111827] ${isRtl ? "text-right" : "text-left"}`} dir={isRtl ? "rtl" : "ltr"}>
      <header className="bg-[#F9FAFB] border-b-2 border-[#111827] p-[24px] avoid-break">
        <TitleTag className="text-[34px] font-bold text-[#111827]">{personalInfo.fullName}</TitleTag>
      ...
      <div className="p-[28px]">
        {personalInfo.summary && (
          <section className="mb-6">
            <SectionTag className={`text-[12px] font-bold text-[#111827] border-[#111827] mb-2 uppercase ${isRtl ? "border-r-[3px] pr-[10px]" : "border-l-[3px] pl-[10px]"}`}>
