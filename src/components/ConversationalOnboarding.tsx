  ...
  return (
    <div className="fixed inset-0 bg-zinc-900/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <motion.div
        ...
        className="bg-slate-50 p-8 rounded-3xl shadow-2xl max-w-lg w-full border border-slate-200"
      >
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="text-sm text-white0 font-medium">
            ...
            <div className="grid gap-4">
              {steps[step].options.map((option) => (
                <button
                  ...
                  className="text-start p-4 rounded-xl bg-slate-50 hover:bg-emerald-50 border border-slate-200 hover:border-emerald-500 transition-all font-medium"
                >
                  {option}
                </button>
              ))}
