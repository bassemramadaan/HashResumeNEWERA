    ...
    <section className="py-16 bg-slate-50 dark:bg-slate-950 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10">
          ...
          {/* Visual Preview */}
          <div className="w-full lg:w-1/2 relative h-[450px] md:h-[550px] bg-slate-200/50 dark:bg-slate-900/50 rounded-[2rem] border border-slate-200 dark:border-slate-800 p-4 md:p-8 overflow-hidden shadow-2xl shadow-slate-200/50 dark:shadow-black/50">
                  ...
                  {activeStep === 2 && (
                    <div className="flex h-full gap-8 items-center justify-center">
                      <div className="w-1/2 space-y-6 opacity-40 blur-[2px] hidden md:block">
                        <div className="h-6 bg-slate-200 dark:bg-slate-800 rounded w-4/5"></div>
                        ...
                        <div className="space-y-5">
                          <div className="flex gap-4 items-center border-b border-slate-100 dark:border-slate-800 pb-4">
                            ...
                            <div className="space-y-2 flex-1">
                              ...
                              <div className="h-4 bg-slate-400 dark:bg-slate-500 rounded w-1/2"></div>
                            </div>
                          </div>
