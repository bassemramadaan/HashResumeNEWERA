      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-slate-100 dark:bg-slate-900 p-6 rounded-2xl border border-slate-200 dark:border-slate-800">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-inner h-64 overflow-hidden text-left text-sm text-slate-500 dark:text-slate-400 font-mono">
          ...
          <div className="bg-orange-50 dark:bg-orange-900/10 p-6 rounded-2xl border border-orange-100 dark:border-orange-800">
            ...
            <div className="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-lg h-64 overflow-hidden text-left text-sm text-slate-700 dark:text-slate-200">
