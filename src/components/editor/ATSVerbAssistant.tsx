                      ...
                      >
                        <div className="space-y-0.5">
                          <div className="flex items-baseline gap-2">
                            ...
                            <span className="text-[10px] font-black text-[#FF4D2D]">
                              {verb.ar}
                            </span>
                          </div>
                ...
                <div className="space-y-6 text-start">
                  ...
                  <div className="space-y-4">
                    <div className="flex gap-2 items-center text-xs font-black text-slate-800">
                      <BookOpen size={16} className="text-[#FF4D2D]" />
                    ...
                    <div className="space-y-2">
                      <div className="p-3 bg-red-50/40 rounded-xl border-l-[3px] border-[#FF4D2D] space-y-1">
                        <span className="text-xs font-black text-[#FF4D2D] block">S - Situation (الموقف)</span>
                      ...
                      <div className="p-3 bg-red-50/40 rounded-xl border-l-[3px] border-[#FF4D2D] space-y-1">
                        <span className="text-xs font-black text-[#FF4D2D] block">T - Task (المهمة)</span>
                        <p className="text-[10px] text-slate-500 leading-relaxed font-medium">
                      ...
                      <div className="p-3 bg-red-50/40 rounded-xl border-l-[3px] border-[#FF4D2D] space-y-1">
                        <span className="text-xs font-black text-[#FF4D2D] block">A - Action (الإجراء)</span>
                        <p className="text-[10px] text-slate-500 leading-relaxed font-medium">
                      ...
                      <div className="p-3 bg-red-50/40 rounded-xl border-l-[3px] border-[#FF4D2D] space-y-1">
                        <span className="text-xs font-black text-[#FF4D2D] block">R - Result (النتيجة)</span>
                        <p className="text-[10px] text-slate-500 leading-relaxed font-medium">
                  ...
                  <div className="pt-4 border-t border-slate-100 space-y-3">
                    <span className="text-xs font-black text-slate-800 flex items-center gap-2">
                      <MessageSquare size={14} className="text-[#FF4D2D]" />
