  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 pt-4 pb-12 overflow-x-auto scrollbar-hide">
      <div className="relative flex items-center justify-between min-w-[500px] sm:min-w-0 px-2">
        ...
        <div className="absolute start-0 top-1/2 -translate-y-1/2 w-full h-[1px] bg-slate-200 dark:bg-slate-800 z-0" />
        
        {/* Active Progress Line */}
        <div 
          className="absolute start-0 top-1/2 -translate-y-1/2 h-[1px] bg-[#ff4d2d] dark:bg-orange-400 transition-all duration-500 z-0" 
