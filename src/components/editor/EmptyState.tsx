...
const EmptyState = ({ icon, title, description, buttonText, onAdd }: EmptyStateProps) => {
  ...
  return (
    <motion.div
      ...
      className="bg-white/50 border border-slate-200 border-dashed rounded-3xl p-8 sm:p-12 flex flex-col items-center justify-center text-center shadow-sm relative overflow-hidden group cursor-pointer hover:border-[#001639]/30 transition-all duration-500"
      onClick={onAdd}
    >
