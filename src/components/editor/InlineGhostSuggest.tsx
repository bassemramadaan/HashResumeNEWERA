  ...
  return (
    ...
    >
      ...
      <p className="font-medium text-slate-500 leading-normal flex items-center gap-1.5 flex-1 pl-1 pr-1 truncate">
        ...
        <span className="font-extrabold text-brand-600 italic max-w-md truncate">
          {suggestion}
        </span>
      </p>
      ...
      <button
        ...
        className="shrink-0 flex items-center gap-1 bg-white border border-slate-200 px-2 py-0.5 rounded-lg font-black text-slate-800 hover:text-brand-600 hover:border-brand-600/20 transition-all cursor-pointer shadow-3xs active:scale-95"
      >
        <span>Tab</span>
