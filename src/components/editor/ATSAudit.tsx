    ...
    return (
      <div className="space-y-6 font-sans">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 text-center transition-colors">
          ...
          <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-2">{t.noDataTitle}</h3>
  ...
  return (
    <div className="space-y-6 font-sans">
      ...
      <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-800 transition-colors">
        ...
        {/* Section Breakdown */}
        <div className="mb-12">
          <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-6">{t.sectionBreakdown}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-8">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">{t.detailedSuggestions}</h3>
            {sections.map((section, idx) => (
          ...
          <div className="space-y-8">
            <h3 className="text-xl font-bold text-slate-900 dark:text-white">{t.workingWell}</h3>
            {sections.map((section, idx) => (
              ...
              {matchResults && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="md:col-span-1 bg-white dark:bg-slate-800 p-6 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm flex flex-col items-center justify-center text-center transition-colors">
                    <div className="text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2">{t.matchScore}</div>
                    <div className={cn(
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {matchResults.missing.length > 0 ? matchResults.missing.map(kw => (
                          ...
                          <span className="text-sm text-slate-500 dark:text-slate-400 italic">{t.noMissingKeywords}</span>
                        )}
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {matchResults.matched.length > 0 ? matchResults.matched.map(kw => (
                          ...
                          <span className="text-sm text-slate-500 dark:text-slate-400 italic">{t.noMatchedKeywords}</span>
                        )}
                      </div>
                    </div>
                  </div>
