    ...
    <section className="relative flex items-center overflow-hidden pb-0 pt-16">
      ...
      <div className="container-main w-full py-12 md:py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-100 to-amber-100 border border-primary-200 text-primary-700 rounded-full px-4 py-2 text-sm font-medium mb-6 shadow-sm">
