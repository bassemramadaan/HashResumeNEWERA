      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4 font-display">
            {language === "ar"
              ? "نماذج حقيقية، نجاح حقيقي"
              : "Real Resumes, Real Success"}
          </h2>
                ...
                <div className="h-full w-full bg-slate-50 flex flex-col p-6 text-[8px] leading-relaxed select-none pointer-events-none opacity-80 group-hover:opacity-100 transition-opacity">
                  <div className="flex justify-between items-start mb-6 border-b border-slate-100 pb-4">
                    <div>
                      ...
                      <div
                        className={`text-xs font-semibold ${resume.accent.replace("bg-", "text-")}`}
                      >
                        {resume.role}
                      </div>
                    </div>
                    <div
                      className={`w-8 h-8 rounded-full ${resume.accent} opacity-20`}
                    ></div>
                  </div>

                  <div className="grid grid-cols-3 gap-4 h-full">
                    <div className="col-span-1 space-y-4 border-e border-slate-100 pe-2">
