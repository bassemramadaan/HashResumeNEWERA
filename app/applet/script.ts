...
let content = fs.readFileSync(path.join(basePath, 'src/components/editor/PersonalInfoForm.tsx'), 'utf-8');
...
fs.writeFileSync(path.join(basePath, 'src/components/editor/PersonalInfoForm.tsx'), content);

let skills = fs.readFileSync(path.join(basePath, 'src/components/editor/SkillsForm.tsx'), 'utf-8');
...
fs.writeFileSync(path.join(basePath, 'src/components/editor/SkillsForm.tsx'), skills);
